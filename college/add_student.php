		...
		<?php include"navbar.php";?><br>
			...
			<div id="section">
				...
				<div class="content">
					...
					<?php
						if(isset($_POST["submit"]))
						{
							...
							{
								$sq="insert into student(RNO,ADDNO,SNAME,FNAME,SDEPT,SSEC,DOB,GEN,PHO,MAIL,ADDR,PCO,SIMG) values('{$_POST["rno"]}','{$_POST["addno"]}','{$_POST["name"]}','{$_POST["fname"]}','{$_POST["dep"]}','{$_POST["sec"]}','{$edate}','{$_POST["gen"]}','{$_POST["pho"]}','{$_POST["email"]}','{$_POST["addr"]}','{$_POST["pco"]}','{$target_file}')";
				...
				<div class="lbox">
					...
					<label> Add no</label><br>
					<input type="text" class="input3" name="addno"><br><br>
				...
				<label> Mail Id</label><br>
					...
					<input type="text" class="input3" name="pco"><br><br>
